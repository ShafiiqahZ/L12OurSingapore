...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "singaporeIslands.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createIslandsTableSql = "CREATE TABLE " + TABLE_ISLAND + "("
                + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + COLUMN_NAME + " TEXT, "
                + COLUMN_DESCRIPTION + " TEXT, "
                + COLUMN_SIZE + " INTEGER, "
                + COLUMN_STARS + " INTEGER )";
        db.execSQL(createIslandsTableSql);
        Log.i("info", createIslandsTableSql + "\ncreated tables");
    }
    ...
    public ArrayList<OurSingapore> getAllIslands() {
        ArrayList<OurSingapore> islandList = new ArrayList<OurSingapore>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                OurSingapore newIsland = new OurSingapore(id, name, description, size, stars);
    ...
    public ArrayList<OurSingapore> getAllIslandsByStars(int starsFilter) {
        ArrayList<OurSingapore> islandList = new ArrayList<OurSingapore>();
    ...
    public int updateIsland(OurSingapore data){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
